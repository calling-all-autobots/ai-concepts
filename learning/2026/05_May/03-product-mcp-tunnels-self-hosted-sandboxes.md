...
## Connects to
- [MCP](../../../06-agents/33-mcp.md) · [tool calling](../../../06-agents/32-tool-calling.md) · [AI security](../../../08-safety-trust/42-ai-security.md) · [production architecture](../../../10-production-ops/48-production-architecture.md)
