...
1. **Attention** — the mixing step: each token pulls in relevant information from the other tokens. Think of it as *routing* — deciding what to look at. (The mechanism is [Attention](03-attention.md); here we just use it.)
