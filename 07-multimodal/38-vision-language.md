...
- more compute and money per call (you pay per token — see [cost and unit economics](../10-production-ops/51-cost-unit-economics.md)),
- more of your [context window](../01-foundations/05-context-windows.md) consumed by one picture, and
- higher latency.
