...
- **[Distillation](distillation.md)** produces a *different, smaller* model — a compact "student" trained to imitate the big "teacher." That's a training project, and it's the other lesson's subject; the contrast is the point here.
...
- **Two compression families: quantization shrinks the numbers, [distillation](distillation.md) shrinks the network.** They stack.
