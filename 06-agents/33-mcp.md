...
- **Tools** — functions the model can call. This is the [tool-calling](32-tool-calling.md) primitive, now *discovered dynamically* over the protocol instead of hardcoded into the app.
- **Resources** — data or content the server can hand over to load into the model's [context](../01-foundations/05-context-windows.md): files, records, documents.
